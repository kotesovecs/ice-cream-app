...
import 'package:ice_cream/ui/views/checkout/checkout_view.dart' as _i7;
import 'package:ice_cream/ui/views/history/history_view.dart' as _i4;
import 'package:ice_cream/ui/views/main/main_view.dart' as _i3;
import 'package:ice_cream/ui/views/settings/settings_view.dart' as _i6;
import 'package:ice_cream/ui/views/startup/startup_view.dart' as _i2;
...
class Routes {
  ...
  static const todaysSelectionView = '/todays-selection-view';
...
class StackedRouter extends _i1.RouterBase {
  final _routes = <_i1.RouteDef>[
    ...
    _i1.RouteDef(
      Routes.todaysSelectionView,
      page: _i5.TodaysSelectionView,
    ),
    _i1.RouteDef(
      Routes.settingsView,
  ...
  final _pagesMap = <Type, _i1.StackedRouteFactory>{
    ...
    _i5.TodaysSelectionView: (data) {
      return _i8.MaterialPageRoute<dynamic>(
        builder: (context) => const _i5.TodaysSelectionView(),
        settings: data,
      );
    },
...
extension NavigatorStateExtension on _i9.NavigationService {
  ...
  Future<dynamic> navigateToTodaysSelectionView([
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
    ...
    return navigateTo<dynamic>(Routes.todaysSelectionView,
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
  ...
  Future<dynamic> replaceWithTodaysSelectionView([
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
    ...
    return replaceWith<dynamic>(Routes.todaysSelectionView,
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
